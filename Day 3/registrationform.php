            ...
            <form action="printData.php" method="get">
                <table>
                    ...
                    <tr>
                        ...
                        <!--<td>Languages :</td>
                        <td><input type="checkbox" name="c1" value="Gujarati" required=""/>Gujarati<br/>
                            <input type="checkbox" name="c2" value="Hindi" required=""/>Hindi<br/>
                            <input type="checkbox" name="c3" value="English" required=""/>English
                        </td>-->
                    </tr>
                    <tr>
